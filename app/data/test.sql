...
INSERT INTO recipes (title, description, prep_time, cook_time, difficulty_level, meal_type, season, is_premium, premium_rank, ingredients, steps, servings, author_id, image_url, age_category, origin)
VALUES
...
VALUES
  ...
  ('Salade de concombre', 'Salade fraiche et legere pour l''ete.', 10, 0, 'easy', 'lunch', 'summer', false, NULL,
    ...
    'toute la famille', 'méditerranéen'),
